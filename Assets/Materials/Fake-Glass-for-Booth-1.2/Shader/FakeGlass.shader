...
Shader "Silent/FakeGlass"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float3 normalMap87 = ( UnpackScaleNormal( SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, uv_BumpMap ), _NormalScale ) * switchResult137 );
			...
			float temp_output_2_0_g8 = _ShadowTransparency;
			...
			#ifdef UNITY_PASS_SHADOWCASTER
				float3 staticSwitch201 = ( ( ( temp_cast_5 * temp_output_2_0_g8 ) + appendResult7_g8 ) * ( 1.0 - saturate( temp_output_225_0 ) ) );
			#else
			...
			float occlusion116 = SAMPLE_TEXTURE2D( _OcclusionMap, sampler_OcclusionMap, uv_OcclusionMap ).g;
			...
			float temp_output_2_0_g9 = metallic177;
			...
			UnityGI gi298 = gi;
			float3 diffNorm298 = worldNormal206;
			gi298 = UnityGI_Base( data, 1, diffNorm298 );
			float3 indirectDiffuse298 = gi298.indirect.diffuse + diffNorm298 * 0.0001;
			c.rgb = max( ( ( finalRefraction261 * localFresnelLerp47 * localsurfaceReduction55 ) + ( ( ( mainTint174.rgb * temp_output_2_0_g9 ) + appendResult7_g9 ) * indirectSpecular66 * localInvFresnelPow5200 * surfaceSmoothness166 ) + ( ( _InteriorDiffuseStrength * indirectDiffuse298 ) * dotResult279 ) ) , float3( 0,0,0 ) );
...
/*ASEBEGIN
Version=18800
2085;425;1599;1521;260.8311;181.3209;1;True;False
Node;AmplifyShaderEditor.CommentaryNode;103;-2802.456,-875.3262;Inherit;False;1086.169;452.8964;Normal Map;8;28;87;9;30;137;139;140;153;;1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;153;-2633.094,-829.7634;Inherit;False;Property;_NormalScale;Normal Scale;4;0;Create;True;0;0;0;False;0;False;1;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;139;-2522.384,-581.1627;Inherit;False;Constant;_NormalFlip;NormalFlip;13;0;Create;True;0;0;0;False;0;False;1,1,-1;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.TextureCoordinatesNode;30;-2544.456,-723.403;Inherit;False;0;9;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;9;-2320.14,-747.4296;Inherit;True;Property;_BumpMap;Normal Map;3;1;[Normal];Create;False;0;0;0;False;1;Header(Material Properties);False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SwitchByFaceNode;137;-2210.384,-541.1627;Inherit;False;2;0;FLOAT3;1,1,1;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;140;-2020.384,-595.1627;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.CommentaryNode;269;-4645.663,-25.61247;Inherit;False;2643.855;894.5969;Refracted reflection;35;252;31;255;233;27;241;102;191;239;238;244;26;243;53;242;240;180;190;119;206;195;186;5;7;1;8;267;6;3;266;4;261;270;292;293;;1,1,1,1;0;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;87;-1975.285,-748.8854;Float;False;normalMap;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;102;-4595.663,458.1873;Inherit;False;87;normalMap;1;0;OBJECT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.CommentaryNode;257;-2010.106,1592.989;Inherit;False;1259.973;519.9999;Surface Mask;11;144;152;148;143;150;149;151;166;146;165;96;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SamplerNode;96;-1960.106,1882.989;Inherit;True;Property;_SurfaceMask;Surface Mask;12;0;Create;True;0;0;0;False;1;Header(Additional Properties);False;-1;None;None;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;144;-1944.106,1722.989;Inherit;False;Property;_SurfaceSmoothnessTweak;Surface Smoothness Tweak;15;0;Create;True;0;0;0;False;0;False;0;0;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;118;-1412.417,-654.4614;Inherit;False;0;115;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;152;-1560.106,1738.989;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;150;-1342.99,1741.555;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;143;-1944.106,1642.989;Inherit;False;Property;_SurfaceLevelTweak;Surface Level Tweak;14;0;Create;True;0;0;0;False;0;False;0;0;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;148;-1944.106,1802.989;Inherit;False;Property;_SurfaceSmoothness;Surface Smoothness ;13;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;151;-1560.106,1642.989;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;149;-1172.99,1766.555;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;146;-1344.99,1646.555;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;166;-999.1334,1760.113;Inherit;False;surfaceSmoothness;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;165;-976.7523,1659.47;Inherit;False;surfaceLevel;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;297;141.0215,357.3008;Inherit;False;206;worldNormal;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.IndirectDiffuseLighting;298;356.2568,361.1205;Inherit;False;World;1;0;FLOAT3;0,0,1;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;300;313.1689,270.6791;Inherit;False;Property;_InteriorDiffuseStrength;Interior Diffuse Strength;11;0;Create;True;0;0;0;False;0;False;0.1;0.1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;224;928.1288,1681.635;Inherit;False;Lerp White To;-1;;8;047d7c189c36a62438973bad9d37b1c2;0;2;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;199;-102.4541,1364.07;Inherit;False;181;NdotV;1;0;OBJECT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;294;606.2914,339.9841;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.IndirectSpecularLight;66;-34.0536,1154.823;Inherit;False;Tangent;3;0;FLOAT3;0,0,1;False;1;FLOAT;1;False;2;FLOAT;1;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;176;-351.2544,1035.483;Inherit;False;Lerp White To;-1;;9;047d7c189c36a62438973bad9d37b1c2;0;2;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;299;-35.1441,1444.968;Inherit;False;166;surfaceSmoothness;1;0;OBJECT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CustomExpressionNode;200;63.5459,1363.07;Inherit;False;return 1-Pow5(1-x)@;1;False;1;True;x;FLOAT;0;In;;Inherit;False;InvFresnelPow5;True;False;0;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;169;306.3603,1037.053;Inherit;False;4;4;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;291;671.0161,-72.16928;Inherit;False;181;NdotV;1;0;OBJECT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TextureTransformNode;28;-2752.456,-707.403;Inherit;False;9;False;1;0;SAMPLER2D;;False;2;FLOAT2;0;FLOAT2;1
...
ASEEND*/
//CHKSM=F887B4BD29ADEF08ADD13888A6F2B4CA7DAB6B93